...
class MEsuRASSpec extends AnyFreeSpec with Matchers with HasDebugPrint {
  "MiniRAS should handle push, pop, commit and rollback correctly" in {
    LogUtil.setLogLevel(LogLevel.OFF)
    debugPrint = false
    simulate(new MEsuRAS(4)) { dut =>
